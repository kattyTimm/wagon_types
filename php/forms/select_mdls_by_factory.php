        <div class="modal fade" id="select_mdls_by_factory" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true" ondrop="return false;" ondragover="return false;"
            ...
            <div class="modal-dialog">
                <div class="modal-content y-modal-shadow">
                    <div class="modal-header">
                        <div class="modal-title w-100 p-0">
                            <div class="y-flex-row-nowrap p-0 align-items-center">
                                <h4 id="fm_mdl_ttl" class="y-dgray-text">Завод-изготовитель. <small><i id="fm_mdl_ttl_add" class="y-dgray-text"></i></small></h4>
                    ...
                    <div class="modal-body">
                        <form role="form" autocomplete="off" onsubmit="return false">                              
                            ...
                            <div class="form-group">
                                <small><label for="factories_list">Завод-изготовитель:</label></small>
                    ...
                    <div class="modal-footer y-modal-footer-bk">
                        ...
                        <button id="select_factory_ok" class="btn btn-primary y-shad">Ok</button>
                    </div>
                </div>
            </div>
        </div>